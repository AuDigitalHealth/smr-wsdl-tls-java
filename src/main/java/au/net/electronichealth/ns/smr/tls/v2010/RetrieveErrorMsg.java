 ...
 * 
 */
@WebFault(name = "retrieveError", targetNamespace = "http://ns.electronichealth.net.au/smd/svc/SealedMessageRetrieval/2010")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: au.net.electronichealth.ns.smr.tls.v2010.RetrieveErrorType
     */
