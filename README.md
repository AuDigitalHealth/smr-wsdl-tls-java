...
This library provides the required Sealed Message Retrieval artefacts required to support Secure Message Delivery (SMD) specifications.
...
-   WSDL/XSD source files should be used in conjunction with JAX-WS and wsimport
    ...
    /smr-wsdl-tls-<version>-sources.jar
